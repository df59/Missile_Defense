...
export default class GameOverScene extends Phaser.Scene {
  ...
  create() {
    ...
    const title = this.add
      .text(this.cameras.main.width / 2, this.cameras.main.height / 2 - 250, "Game Over", { fontSize: "32px", fill: "#fff" })
      .setOrigin(0.5);

    // Display the score
    const scoreText = this.add
      .text(this.cameras.main.width / 2, this.cameras.main.height / 2 - 150, `Your Score: ${this.score}`, {
        fontSize: "24px",
        fill: "#fff",
      })
      .setOrigin(0.5);
