...
export default class MainMenuScene extends Phaser.Scene {
  ...
  create() {
    ...
    const title = this.add
      .text(this.cameras.main.width / 2, this.cameras.main.height / 2 - 200, "Missile Defense", { fontSize: "48px", fill: "#fff" })
      .setOrigin(0.5);

    // Create buttons
    const playButton = this.buttons.createButton(this, this.cameras.main.width / 2, this.cameras.main.height / 2 - 50, "Play", () => {
      this.scene.start("play-scene");
    });
    const highScoresButton = this.buttons.createButton(
      this,
    ...
    const tutorialButton = this.buttons.createButton(
      this,
      this.cameras.main.width / 2,
