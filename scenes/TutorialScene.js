...
export default class TutorialScene extends Phaser.Scene {
  ...
  create() {
    ...
    const title = this.add
      .text(this.cameras.main.width / 2, this.cameras.main.height / 2 - 360, "Tutorial", { fontSize: "32px", fill: "#fff" })
      .setOrigin(0.5);
    ...
    const backButton = this.buttons.createButton(this, this.cameras.main.width / 2, this.cameras.main.height / 2 + 300, "Back", () => {
