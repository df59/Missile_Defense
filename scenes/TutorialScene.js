...
export default class TutorialScene extends Phaser.Scene {
  ...
  create() {
    ...
    const title = this.add
      .text(
        this.cameras.main.width / 2,
        this.cameras.main.height / 2 - 360,
        "Tutorial",
    ...
    const tutorialImage1 = this.add.image(
    ...
    const description1 = this.add.text(
      ...
      this.cameras.main.height / 2 - 300,
      "Move your tank left and right with A and D.",
      { fontSize: "24px", fill: "#fff" }
    );

    const tutorialImage2 = this.add.image(
      this.cameras.main.width / 2 - 450,
      this.cameras.main.height / 2 - 200,
      "missile1"
    );
    tutorialImage2.setScale(0.7);
    const tutorialImage3 = this.add.image(
      this.cameras.main.width / 2 - 400,
      this.cameras.main.height / 2 - 200,
      "missile2"
    );
    ...
    const description2 = this.add.text(
      this.cameras.main.width / 2 - 250,
      this.cameras.main.height / 2 - 200,
      "Different missiles will fall from the sky.",
      { fontSize: "24px", fill: "#fff" }
    );

    const tutorialImage4 = this.add.image(
      this.cameras.main.width / 2 - 400,
    ...
    const tutorialImage5 = this.add.image(
      this.cameras.main.width / 2 - 470,
      this.cameras.main.height / 2,
      "heart"
    );
    tutorialImage5.setScale(0.5);
    const tutorialImage6 = this.add.image(
      this.cameras.main.width / 2 - 400,
      this.cameras.main.height / 2,
      "carePackage"
    );
    tutorialImage6.setScale(0.3);
    const description4 = this.add.text(
      this.cameras.main.width / 2 - 250,
      this.cameras.main.height / 2,
      "Collect money and health powerups on the ground.",
      { fontSize: "24px", fill: "#fff" }
    );
    ...
    const tutorialImage7 = this.add.image(
      this.cameras.main.width / 2 - 400,
      this.cameras.main.height / 2 + 200,
      "turret"
    );
